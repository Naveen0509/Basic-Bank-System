...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color:green">
              <div class="col-sm-12 col-md" style="background-color:green">
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    <img src="img/history.jpg" class="img-fluid" width=400 height=800>
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Naveen Kumar S</b> <br></p>
      </footer>
